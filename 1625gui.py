...
def submit():
    elements = [entry.get().strip() for entry in entries]
...
# Header label
tk.Label(root, text="Enter 5 Elements", font=("Arial", 14)).pack(pady=10)
...
# Footer label
tk.Label(root, text="PL 101 Midterm Exam Question", font=("Arial", 9, "italic")).pack(side=tk.BOTTOM, pady=5)
